    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            listBox1.Items.Add("Rota: "+comboBox1.Text+"-"+comboBox2.Text+" Tarih"+dateTimePicker1.Text+" Saat:"+maskedTextBox1.Text+
                "Yolcu Bilgileri ~~AD:"+textBox1.Text+" Tc:"+maskedTextBox2.Text+" Tel"+maskedTextBox3.Text);
            MessageBox.Show("Kayit Yapildi");
        }

        private void button2_Click(object sender, EventArgs e)
        {
            string degisebilir = comboBox1.SelectedItem.ToString();
            comboBox1.Text = comboBox2.Text;
            comboBox2.Text = degisebilir;
